...
In short, this program simulates the heat transfer process of rectangular plates and reports how much time was needed to reach thermal equilibrium, updated *with the newly added possibility of concurrent processing of plates*.
...
|31 | Queue initialization error m|`Error: could not initialize queue`
|32 | Can consume mutex intialization error  m|`Error: could not initialize queue semaphore`
|33 | Mutex initialization error m|`Error: could not initialize mutex`
|34 | Semaphore initialization error m|`Error: could not initialize states semaphore`
|35 | Thread team could not be created m|`Error: Could not create thread team for plate ##`
|36 | Thread could not be created m|`Error: could not create thread ##`
