...
Si lo que se busca es cierta ruta, por ejemplo, imprimir 7, hay que usar control de concurrencia para asegurar que los demas casos no ocurran.
...
****
*Respuesta*: 
10000, si los hilos van uno por uno, serial (puede ser que habia solo una CPU)
****
...
a. hay sincronizacion perfecta de hilos

b. un hilo se queda con un 0 al inicio y sobreescribe el trabajo de todos los demas luego de que terminen y toma CPU otra vez.
****
...
*Respuesta*: hello_world_semaphore, donde hay un arreglo de semaforos, con el primero inicializado en 1 y el resto en 0. Cuando termina un hilo, avisa al semaforo del siguiente que puede trabajar.
