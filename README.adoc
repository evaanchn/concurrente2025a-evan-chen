...
|22 m|link:pthreads/network_simul_producers[network_simul_producers] | Ejemplo en clase |Se modifica el codigo de link:pthreads/network_simul_packet_loss2[network_simul_packet_loss2] tal que se pueden solicitar multiples productores.
|23 m|link:pthreads/network_simul_bound[network_simul_bound] | Ejemplo en clase |Se modifica el codigo de link:pthreads/network_simul_producers[network_simul_producers], de forma que las colas pueden ser acotadas.
|===
